;; [[file:../../../../tmp/config.org.GuQd8l::*File variables][File variables:1]]
;;; ~/.config/doom/config.el -*- lexical-binding: t; -*-
;; File variables:1 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Personal information][Personal information:1]]
...
;; [[file:../../../../tmp/config.org.GuQd8l::*Theme][Theme:1]]
...
;; [[file:../../../../tmp/config.org.GuQd8l::*Mixed pitch mode][Mixed pitch mode:1]]
(add-hook! (org-mode gfm-mode markdown-mode) #'mixed-pitch-mode)
(setq mixed-pitch-set-height t)
;; Mixed pitch mode:1 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Maximize][Maximize:1]]
(add-to-list 'default-frame-alist '(fullscreen . maximized))
;; Maximize:1 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Editor behavior][Editor behavior:1]]
(remove-hook 'doom-first-buffer-hook #'ws-butler-global-mode)
(after! editorconfig
    (setq editorconfig-trim-whitespaces-mode nil))
;; Editor behavior:1 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Deletion][Deletion:1]]
(setq delete-by-moving-to-trash t)
;; Deletion:1 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Deletion][Deletion:2]]
(setq evil-want-fine-undo t)
;; Deletion:2 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Auto-save][Auto-save:1]]
(setq auto-save-visited-interval 30) ; Save after 30s of idle time.
(auto-save-visited-mode t)
;; Auto-save:1 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Auto-save][Auto-save:2]]
...
;; [[file:../../../../tmp/config.org.GuQd8l::*Line wrapping][Line wrapping:1]]
(setq-default fill-column 120)
(add-hook! '(text-mode-hook prog-mode-hook conf-mode-hook)
           #'display-fill-column-indicator-mode)
;; Line wrapping:1 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Line wrapping][Line wrapping:2]]
;; (remove-hook 'text-mode-hook #'auto-fill-mode)
;; (add-hook 'text-mode-hook #'+word-wrap-mode)
;; Line wrapping:2 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Window splitting][Window splitting:1]]
(setq evil-vsplit-window-right t
      evil-split-window-below t)
;; Window splitting:1 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Window splitting][Window splitting:2]]
(setq split-width-threshold 240)
;; Window splitting:2 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Clipboard and Copy/Paste][Clipboard and Copy/Paste:1]]
(setq select-enable-clipboard t)
;; Clipboard and Copy/Paste:1 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Clipboard and Copy/Paste][Clipboard and Copy/Paste:2]]
(map!
 :i "C-S-v" #'yank)
;; Clipboard and Copy/Paste:2 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Which-key][Which-key:1]]
(setq which-key-idle-delay 0.5)
;; Which-key:1 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Authinfo][Authinfo:1]]
(setq auth-sources '("~/.authinfo.gpg"))
;; Authinfo:1 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*atomic-chrome configuration][atomic-chrome configuration:1]]
...
;; [[file:../../../../tmp/config.org.GuQd8l::*caddyfile-mode][caddyfile-mode:1]]
...
;; [[file:../../../../tmp/config.org.GuQd8l::*Projects][Projects:1]]
(setq projectile-project-search-path '("~/devel/" "~/sky" "~/gatech"))
;; Projects:1 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Projects][Projects:2]]
...
;; [[file:../../../../tmp/config.org.GuQd8l::*Smart parentheses][Smart parentheses:1]]
(map!
 :ni "M-u"   #'sp-up-sexp)
;; Smart parentheses:1 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Dired][Dired:1]]
(add-hook 'dired-mode-hook #'turn-off-evil-snipe-mode)
;; Dired:1 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Workspaces][Workspaces:1]]
(setq +workspaces-on-switch-project-behavior t)
;; Workspaces:1 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Workspaces][Workspaces:2]]
(map! :leader
...
;; [[file:../../../../tmp/config.org.GuQd8l::*Zen][Zen:1]]
...
;; [[file:../../../../tmp/config.org.GuQd8l::*Treemacs][Treemacs:1]]
(after! treemacs
  (treemacs-follow-mode 1)
  (setq treemacs-width 40))
;; Treemacs:1 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Pretty-code][Pretty-code:1]]
(setq +pretty-code-symbols nil)
;; Pretty-code:1 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Completion][Completion:1]]
(after! company
  (remove-hook 'evil-normal-state-entry-hook #'company-abort))
;; Completion:1 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Flyspell][Flyspell:1]]
;; (after! flyspell (flyspell-lazy-mode 1))
;; Flyspell:1 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Configuration][Configuration:1]]
(set-email-account!
 "r-vn.org"
...
;; [[file:../../../../tmp/config.org.GuQd8l::*Configuration][Configuration:2]]
(after! mu4e
...
;; [[file:../../../../tmp/config.org.GuQd8l::*Configuration][Configuration:3]]
...
;; [[file:../../../../tmp/config.org.GuQd8l::*Configuration][Configuration:4]]
(map!
 :leader
 :prefix "o"
 :desc "Mail" "m" #'=mu4e)
...
;; [[file:../../../../tmp/config.org.GuQd8l::*Configuration][Configuration:5]]
(setq shr-color-visible-luminance-min 80)
;; Configuration:5 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Configuration][Configuration:6]]
...
;; [[file:../../../../tmp/config.org.GuQd8l::*Language Server Protocol (LSP)][Language Server Protocol (LSP):1]]
(map! :leader
      (:prefix "c"
       :desc "LSP Parameters" "p" #'lsp-signature-activate))
;; Language Server Protocol (LSP):1 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Language Server Protocol (LSP)][Language Server Protocol (LSP):2]]
...
;; [[file:../../../../tmp/config.org.GuQd8l::*Language Server Protocol (LSP)][Language Server Protocol (LSP):3]]
;(setq lsp-log-io t)
;; Language Server Protocol (LSP):3 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Language Server Protocol (LSP)][Language Server Protocol (LSP):4]]
...
;; [[file:../../../../tmp/config.org.GuQd8l::*Magit][Magit:1]]
(setq magit-prefer-remote-upstream t)
;; Magit:1 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Magit][Magit:2]]
(setq forge-topic-list-limit '(30 . 6))
;; Magit:2 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Magit][Magit:3]]
(after! magit-refs
  (remove-hook 'magit-refs-sections-hook 'magit-insert-tags))
;; Magit:3 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Golang][Golang:1]]
(setq lsp-gopls-hover-kind "FullDocumentation")
;; Golang:1 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Org Mode][Org Mode:1]]
(setq org-directory "~/Dropbox/Notes/")
;; Org Mode:1 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Editor][Editor:1]]
(setq org-imenu-depth 6)
;; Editor:1 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Visuals][Visuals:1]]
(custom-set-faces!
...
;; [[file:../../../../tmp/config.org.GuQd8l::*Visuals][Visuals:2]]
(setq
 org-ellipsis " ▼ "
 org-superstar-headline-bullets-list '("☰" "☱" "☲" "☳" "☴" "☵" "☶" "☷" "☷" "☷" "☷"))
;; Visuals:2 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Archiving][Archiving:1]]
...
;; [[file:../../../../tmp/config.org.GuQd8l::*Download][Download:1]]
(after! org-download
...
;; [[file:../../../../tmp/config.org.GuQd8l::*Exporting (General)][Exporting (General):1]]
(after! org (setq org-export-headline-levels 6))
;; Exporting (General):1 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Exporting to HTML][Exporting to HTML:1]]
...
;; [[file:../../../../tmp/config.org.GuQd8l::*Exporting to HTML][Exporting to HTML:2]]
...
;; [[file:../../../../tmp/config.org.GuQd8l::*Exporting to HTML][Exporting to HTML:3]]
;; (after! org
...
;; [[file:../../../../tmp/config.org.GuQd8l::*Exporting to Beamer][Exporting to Beamer:1]]
(setq org-beamer-theme "[progressbar=foot]metropolis")
;; Exporting to Beamer:1 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Exporting to Beamer][Exporting to Beamer:2]]
(setq org-beamer-frame-level 2)
;; Exporting to Beamer:2 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Exporting to GFM][Exporting to GFM:1]]
(eval-after-load "org"
  '(require 'ox-gfm nil t))
;; Exporting to GFM:1 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Capture templates][Capture templates:1]]
(after! org
...
;; [[file:../../../../tmp/config.org.GuQd8l::*Task settings][Task settings:1]]
(after! org
  (setq
...
;; [[file:../../../../tmp/config.org.GuQd8l::*Contexts][Contexts:1]]
(after! org
  (setq
...
;; [[file:../../../../tmp/config.org.GuQd8l::*Refile targets][Refile targets:1]]
(after! org
  (setq
...
;; [[file:../../../../tmp/config.org.GuQd8l::*Habits][Habits:1]]
(after! org
  (add-to-list 'org-modules 'org-habit t))
;; Habits:1 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Custom Agendas][Custom Agendas:1]]
(after! org
...
;; [[file:../../../../tmp/config.org.GuQd8l::*Custom Agendas][Custom Agendas:2]]
(after! org (setq org-deadline-warning-days 14))
;; Custom Agendas:2 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*All Agenda Function][All Agenda Function:1]]
...
;; [[file:../../../../tmp/config.org.GuQd8l::*Context Agenda Function][Context Agenda Function:1]]
...
;; [[file:../../../../tmp/config.org.GuQd8l::*Agenda Support Functions][Agenda Support Functions:1]]
...
;; [[file:../../../../tmp/config.org.GuQd8l::*Agenda Support Functions][Agenda Support Functions:2]]
...
;; [[file:../../../../tmp/config.org.GuQd8l::*Agenda Searches][Agenda Searches:1]]
(after! org (setq org-agenda-text-search-extra-files '(agenda-archives)))
;; Agenda Searches:1 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*Agenda Searches][Agenda Searches:2]]
(after! org (setq org-agenda-search-view-always-boolean t))
;; Agenda Searches:2 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*org-roam][org-roam:1]]
(setq org-roam-directory (concat org-directory "roam/"))
;; org-roam:1 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*org-roam][org-roam:2]]
...
;; [[file:../../../../tmp/config.org.GuQd8l::*org-roam][org-roam:3]]
(setq deft-directory org-roam-directory)
;; org-roam:3 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*org-roam][org-roam:4]]
(setq org-roam-buffer-no-delete-other-windows t)
;; org-roam:4 ends here

;; [[file:../../../../tmp/config.org.GuQd8l::*org-roam][org-roam:5]]
...
;; [[file:../../../../tmp/config.org.GuQd8l::*org-journal][org-journal:1]]
...
;; [[file:../../../../tmp/config.org.GuQd8l::*Calendar][Calendar:1]]
...
;; [[file:../../../../tmp/config.org.GuQd8l::*Alerts][Alerts:1]]
...
;; [[file:../../../../tmp/config.org.GuQd8l::*YAML][YAML:1]]
